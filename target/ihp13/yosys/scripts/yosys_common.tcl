...
proc processAbcScript {abc_script} {
    ...
    set abc_script_stdcell [string map -nocase [list "{TECH_CELLS}" [subst "$src_dir/../../pdk/ihp-sg13g2/ihp-sg13g2/libs.ref/sg13g2_stdcell/lib/sg13g2_stdcell_typ_1p20V_25C.lib"]] $abc_script_recaig]
    set abc_out [open $abc_out_path w]
    puts -nonewline $abc_out $abc_script_stdcell
