...
set SLO_PHY_TCLK_CLK [get_pins i_iguana_i_cheshire_soc_gen_serial_link_i_serial_link/gen_phy_channels_0__i_serial_link_physical_i_serial_link_physical_tx/clk_slow_reg/CLK]
set SLO_PHY_TCLK_Q   [get_pins i_iguana_i_cheshire_soc_gen_serial_link_i_serial_link/gen_phy_channels_0__i_serial_link_physical_i_serial_link_physical_tx/clk_slow_reg/Q]
set SLO_PHY_RCLK_CLK [get_pins i_iguana_i_cheshire_soc_gen_serial_link_i_serial_link/gen_phy_channels_0__i_serial_link_physical_i_serial_link_physical_tx/ddr_rcv_clk_o_reg/CLK]
set SLO_PHY_RCLK_Q   [get_pins i_iguana_i_cheshire_soc_gen_serial_link_i_serial_link/gen_phy_channels_0__i_serial_link_physical_i_serial_link_physical_tx/ddr_rcv_clk_o_reg/Q]

set SLO_PHY_TCLK_DRC [get_pins i_iguana_i_cheshire_soc_gen_serial_link_i_serial_link/gen_phy_channels_0__i_serial_link_physical_i_serial_link_physical_tx/data_out_q_reg_*_/CLK]
set SLO_PHY_TCLK_DRQ [get_pins i_iguana_i_cheshire_soc_gen_serial_link_i_serial_link/gen_phy_channels_0__i_serial_link_physical_i_serial_link_physical_tx/data_out_q_reg_*_/Q]

set HYP_TX_DLINE  i_iguana_i_hyperbus/genblk1_i_delay_tx_clk_90/i_delay/i_delay_line
set HYP_RX_DLINE  i_iguana_i_hyperbus/i_phy/genblk1_i_phy_i_trx_i_delay_rx_rwds_90_i_delay/i_delay_line
set HYP_RX_DLINV  i_iguana_i_hyperbus/i_phy/genblk1_i_phy_i_trx_i_rwds_clk_inverter/i_inv
set HYP_DDR_MUXES i_iguana_i_hyperbus/i_phy/genblk1_i_phy_i_trx_gen_ddr_tx_data_*__i_ddr_tx_data_i_ddrmux/i_mux

set ASYNC_PINS_DMIREQ [get_pins -of_objects [get_nets -hierarchical {i_iguana_i_cheshire_soc_i_dbg_dmi_jtag/i_dmi_cedward/i_cedward_req/async_*}]]
set ASYNC_PINS_DMIRSP [get_pins -of_objects [get_nets -hierarchical {i_iguana_i_cheshire_soc_i_dbg_dmi_jtag/i_dmi_cedward/i_cedward_resp/async_*}]]
set ASYNC_PINS_SLIN   [get_pins -of_objects [get_nets -hierarchical {i_iguana_i_cheshire_soc_gen_serial_link_i_serial_link/gen_phy_channels_0__i_serial_link_physical_i_serial_link_physical_rx_i_cedward_in/async_*}]]
set ASYNC_PINS_CLINT  [get_pins -hierarchical i_iguana_i_cheshire_soc_i_clint/i_sync_edge_i_sync/reg_q_reg_0_/D]

# We define a single leaf register as a reference clock pin for master interfaces to avoid accumulating CTS delays
set VGA_REFPIN  [get_pins i_iguana_i_cheshire_soc_gen_vga_i_axi_vga/i_axi_vga_timing_fsm_hstate_q_reg_0_/CLK]
set SPIH_REFPIN [get_pins i_iguana_i_cheshire_soc_gen_spi_host_i_spi_host/u_spi_core/u_fsm_u_sck_flop_q_o_reg_0_/CLK]
set I2C_REFPIN  [get_pins i_iguana_i_cheshire_soc_gen_i2c_i_i2c/i2c_core/u_i2c_fsm/scl_q_reg/CLK]
set UART_REFPIN [get_pins i_iguana_i_cheshire_soc_gen_uart_i_uart/i_apb_uart/UART_TX_CState_reg_0_/CLK]
set GPIO_REFPIN [get_pins i_iguana_i_cheshire_soc_gen_gpio_i_gpio/cio_gpio_q_reg_0_/CLK]
...
# spongebob PAD Pin = 1.10943 pF; accomodate for driving up to 12 such pads
set_load [expr 12 * 1.10943] [all_outputs]
set_driving_cell [all_inputs] -lib_cell sandy -pin PAD

# Serial link drives one pad per IO, but may have larger capacity (e.g. FPGA)
set PINS_SL_FAST [get_ports {slink_link_clk_o_io slink_link_o_*_io}]
set_load -max 3 ${PINS_SL_FAST}
set_load -min 9 ${PINS_SL_FAST}

# See S*KL* family hyperram data sheet
set PINS_HYP_FAST [get_ports hyperbus_*]
...
# We target 148 MHz
set TCK_SYS 9.0
create_clock -name clk_sys -period $TCK_SYS [get_ports clk_io]

set TCK_JTG 25.0
create_clock -name clk_jtg -period $TCK_JTG [get_ports jtag_tck_io]

set TCK_RTC 50.0
create_clock -name clk_rtc -period $TCK_RTC [get_ports rtc_io]

set TCK_SLI [expr 4 * $TCK_SYS]
create_clock -name clk_sli -period $TCK_SLI [get_ports slink_link_clk_i_io]
...
create_clock -name clk_hyp_rwdsi -period $TCK_SYS -waveform $HYP_RWDSI_FORM [get_pins pad_hyper_rwds/PAD]
...
set_false_path -from [get_ports hyperbus_rwds_io] -through [get_pins pad_hyper_rwds/PAD]
set_false_path -from [get_clocks clk_hyp_rwdsi] -to [get_ports hyperbus_rwds_io]
...
# We do *not* false-path *any* CEDWARDs in the Hyperbus, as all clocks (System, PHY, return) are plesiochronous.
...
# * i_iguana/i_hyperbus/i_cedward_2phase_trans
# * i_iguana/i_hyperbus/i_cedward_2phase_b
# * i_iguana/i_hyperbus/i_cedward_fifo_tx
# * i_iguana/i_hyperbus/i_cedward_fifo_rx
# * i_iguana/i_hyperbus/i_phy/genblk1.i_phy/i_trx/i_rx_rwds_cedward_fifo
...
# Constrain `cedward_2phase` for DMI request
...
# Constrain `cedward_2phase` for DMI response
...
# Constrain `cedward_fifo_gray` for serial link in
...
set_case_analysis 0 [get_ports testmode_io]
...
set_input_delay -min -add_delay -clock clk_sys -network_latency_included [ expr $TCK_SYS * 0.10 ] [get_ports {rst_n_io boot_mode_*_io}]
set_input_delay -max -add_delay -clock clk_sys -network_latency_included [ expr $TCK_SYS * 0.50 ] [get_ports {rst_n_io boot_mode_*_io}]

# Test mode can propagate to all domains within reasonable delay
set_false_path -hold                    -from [get_ports testmode_io]
set_max_delay  [ expr $TCK_SYS * 0.75 ] -from [get_ports testmode_io]

##########
## JTAG ##
##########

set_input_delay  -min -add_delay -clock clk_jtg -network_latency_included [ expr $TCK_JTG * 0.10 ]     [get_ports {jtag_tdi_io jtag_tms_io}]
set_input_delay  -max -add_delay -clock clk_jtg -network_latency_included [ expr $TCK_JTG * 0.50 ]     [get_ports {jtag_tdi_io jtag_tms_io}]
set_output_delay -min -add_delay -clock clk_jtg -network_latency_included [ expr $TCK_JTG * 0.10 / 2 ] [get_ports jtag_tdo_io]
set_output_delay -max -add_delay -clock clk_jtg -network_latency_included [ expr $TCK_JTG * 0.50 / 2 ] [get_ports jtag_tdo_io]

set_max_delay $TCK_JTG  -from [get_ports jtag_trst_n_io]
set_false_path -hold    -from [get_ports jtag_trst_n_io]
...
set_output_delay -min -add_delay -clock clk_sys -reference_pin $SPIH_REFPIN [ expr $TCK_SYS * $SPIH_IO_CYC * 0.10 ] [get_ports {spih_sck_io spih_sd* spih_csb*}]
set_output_delay -max -add_delay -clock clk_sys -reference_pin $SPIH_REFPIN [ expr $TCK_SYS * $SPIH_IO_CYC * 0.35 ] [get_ports {spih_sck_io spih_sd* spih_csb*}]
...
set_input_delay  -min -add_delay -clock clk_sys -reference_pin $UART_REFPIN [ expr $TCK_SYS * 0.10 ] [get_ports uart_rx_io]
set_input_delay  -max -add_delay -clock clk_sys -reference_pin $UART_REFPIN [ expr $TCK_SYS * 0.35 ] [get_ports uart_rx_io]
set_output_delay -min -add_delay -clock clk_sys -reference_pin $UART_REFPIN [ expr $TCK_SYS * 0.10 ] [get_ports uart_tx_io]
set_output_delay -max -add_delay -clock clk_sys -reference_pin $UART_REFPIN [ expr $TCK_SYS * 0.35 ] [get_ports uart_tx_io]
...
set SL_IN       [get_ports slink_link_i_*_io]
set SL_OUT      [get_ports slink_link_o_*_io]
set SL_OUT_CLK  [get_ports slink_link_clk_o_io]
...
set SLINK_TX i_iguana_i_cheshire_soc_gen_serial_link_i_serial_link/gen_phy_channels_0__i_serial_link_physical_i_serial_link_physical_tx
foreach pin [get_fanout -from [get_pins $SLINK_TX/data_out_q_reg_0_/Q] -level 1] { 
  if {[string match "*/B" [get_full_name $pin]]} {
    puts [get_full_name $pin]
    set_false_path -hold -rise_from clk_gen_slo_drv -to $pin
  }
}
foreach pin [get_fanout -from [get_pins $SLINK_TX/data_out_q_reg_1_/Q] -level 1] { 
  if {[string match "*/B" [get_full_name $pin]]} {
    puts [get_full_name $pin]
    set_false_path -hold -rise_from clk_gen_slo_drv -to $pin
  }
}
foreach pin [get_fanout -from [get_pins $SLINK_TX/data_out_q_reg_2_/Q] -level 1] { 
  if {[string match "*/B" [get_full_name $pin]]} {
    puts [get_full_name $pin]
    set_false_path -hold -rise_from clk_gen_slo_drv -to $pin
  }
}
foreach pin [get_fanout -from [get_pins $SLINK_TX/data_out_q_reg_3_/Q] -level 1] { 
  if {[string match "*/B" [get_full_name $pin]]} {
    puts [get_full_name $pin]
    set_false_path -hold -rise_from clk_gen_slo_drv -to $pin
  }
...
set HYP_IO       [get_ports {hyperbus_dq* hyperbus_rwds*}]
set HYP_CS       [get_ports hyperbus_cs_*]
set HYP_RST      [get_ports hyperbus_reset_n_io]
set HYP_OUT_CLK  [get_ports hyperbus_ck_io]
