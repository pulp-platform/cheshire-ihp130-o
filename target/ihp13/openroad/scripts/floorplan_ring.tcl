...
# LLC Way-1
set X [expr $X + $RamSize1024_W + $channelX]
set Y [expr $floor_topY - $RamSize1024_H]
...
add_macro_blockage $macroMargin $axi_data_0_low $axi_data_1_high
...
add_macro_blockage 0 $axi_data_2_low $axi_data_3_high
...
set X [expr $floor_leftX + $RamSize256_W + $channelX]
set Y [expr $floor_bottomY]
...
add_macro_blockage 0 $cva6_wt_dcache_data_3_high $cva6_wt_dcache_data_0_low
...
set X [expr $X - $RamSize256_W - $channelX]
set Y [expr $floor_bottomY]
...
add_macro_blockage $macroMargin $cva6_icache_data_3_low $cva6_icache_data_0_high
