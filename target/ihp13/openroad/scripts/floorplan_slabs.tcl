...
addHaloToBlock $haloBlockL $haloBlockB $haloBlockR $haloBlockT $axi_data_2_high
set X [expr $X ]
set Y [expr $Y - $macroMargin - $RamSize1024x64_H]
placeInstance $axi_data_2_low $X $Y R0
addHaloToBlock $haloBlockL $haloBlockB $haloBlockR $haloBlockT $axi_data_2_low

# LLC Way-3
set X [expr $X + $RamSize1024x64_W + $channelX]
set Y [expr $floor_topY - $RamSize1024x64_H]
placeInstance $axi_data_3_high $X $Y R0
addHaloToBlock $haloBlockL $haloBlockB $channelX $haloBlockT $axi_data_3_high
set X [expr $X ]
set Y [expr $Y - $macroMargin - $RamSize1024x64_H]
placeInstance $axi_data_3_low $X $Y R0
addHaloToBlock $haloBlockL $haloBlockB $channelX $haloBlockT $axi_data_3_low
...
##########################################################################
# L1-Instruction cache goes into the bottom-left
