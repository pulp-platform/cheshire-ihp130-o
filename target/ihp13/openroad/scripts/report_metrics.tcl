...
proc report_metrics { when {include_erc false} {include_clock_skew false} } {
  reopenStdout reports/$when.log
  report_metrics_internal $when $include_erc $include_clock_skew
  reopenStdout /dev/tty
}

proc report_metrics_internal { when {include_erc true} {include_clock_skew true} } {
